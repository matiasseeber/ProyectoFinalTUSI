...
public class DBLoadAllNotDeliveredOrdersClient extends AsyncTask<Boolean, Void, Boolean> {
    ...
    public DBLoadAllNotDeliveredOrdersClient() {
    }
    ...
    public void CargarPedidosPendientes() {
        try {
            ...
            String query = "Select * from PedidosCabecera inner join Clientes on id_Cliente = Clientes.id " +
                    ...
                    "PedidosCabecera.id_Tarjeta where PedidosCabecera.estado = 3 and Clientes.id = " + idCliente + ";";
    ...
    protected void onPostExecute(Boolean response) {
        ...
        grid.setAdapter(new PedidosSinEntregarClienteAdapter(context, pedidoCabeceras));
    }
}