...
public class PedidosPendientesClienteAdapter extends BaseAdapter {
    private ArrayList<PedidoCabecera> elementos;
    private Context context;

    public PedidosPendientesClienteAdapter(Context context, ArrayList<PedidoCabecera> elementos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            view = inflater.inflate(R.layout.grid_template_pedidos_pendientes_usuarios,null);
        }
        ...
        TextView txtMetodoDePago = (TextView) view.findViewById(R.id.txtMetodoPagoPedidosPendienteCliente);
